...
start = time.time()
def summarize(text, model, tokenizer, max_length=1024, num_beams=2):
    ...
    summary_ids = model.generate(inputs, max_length=500, min_length=None, length_penalty=2.0, num_beams=num_beams, early_stopping=True)
